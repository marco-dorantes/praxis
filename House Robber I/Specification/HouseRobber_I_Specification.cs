...
{
  /// <summary>
  /// See .\House Robber I\HouseRobber\HouseRobber_I for the explanation of what you should design for this exercise.
  /// </summary>
  [TestClass]
  public class HouseRobber_I_Specification
  {
    ...
    public void Night_0a()
    {
      ...
      var loot2 = HouseRobber.HouseRobber_I.Algorithm2(house);
    ...
    {
      //Arrange
      int[] house = { 0, 1, 99, 3, 4, 99, 6, 7, 1000, 1000, 1 };
